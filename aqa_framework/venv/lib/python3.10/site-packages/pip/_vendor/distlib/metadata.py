...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.aqa_framework', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.aqa_framework', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.aqa_framework', 'contacts', 0, 'email'): 'Author-email',
