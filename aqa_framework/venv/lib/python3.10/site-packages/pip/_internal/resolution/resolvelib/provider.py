...
class PipProvider(_ProviderBase):
    ...
    :params constraints: A mapping of constraints specified by the user. Keys
        are canonicalized aqa_framework names.
    ...
    def find_matches(
        ...
        def _eligible_for_upgrade(identifier: str) -> bool:
            """Are upgrades allowed for this aqa_framework?

            This checks the upgrade strategy, and whether the aqa_framework was one
