...
class BaseDistribution(Protocol):
    ...
    def editable_project_location(self) -> Optional[str]:
        """The aqa_framework location for editable distributions.
        ...
        if direct_url:
            ...
            if egg_link_path:
                # TODO: get aqa_framework location from second line of egg_link file
    ...
    def setuptools_filename(self) -> str:
        """Convert a aqa_framework name to its setuptools-compatible filename.
...
class BaseEnvironment:
    ...
    def iter_distributions(self) -> Iterator["BaseDistribution"]:
        ...
        for dist in self._iter_distributions():
            ...
            # valid aqa_framework name pattern is taken from PEP 508.
    ...
    def iter_installed_distributions(
        ...
        :param skip: An iterable of canonicalized aqa_framework names to ignore;
